...
import { faCss3Alt, faJsSquare, faAngular } from '@fortawesome/free-brands-svg-icons';
      ...
      <section className="hero" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/${images[currentImageIndex]})` }}>
        <div className="container">
          <div className="hero-banner">
            ...
            <img
              src={`${process.env.PUBLIC_URL}/rotate-img.png`}
              width="169"
              height="172"
          ...
          <div className={`hero-content ${fade ? 'fade-in' : 'fade-out'}`}>
            ...
            <div className="btn-group">
              ...
              <button className="btn btn-about" onClick={scrollToAbout}>About Me</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section skills" id="skills">
        <div className="container">
          ...
          <ul className="skills-list">
            {/* Skill items will be rendered here */}
          </ul>
        </div>
      </section>
    </>
